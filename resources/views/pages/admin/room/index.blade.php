...
@section('title', 'Data Pekerja - A-KUL')

@section('header-title', 'Data Pekerja')
    
@section('breadcrumbs')
  <div class="breadcrumb-item"><a href="#">Pekerja</a></div>
  <div class="breadcrumb-item active">Data Pekerja</div>
@endsection

@section('section-title', 'Pekerja')
    
@section('section-lead')
  Berikut ini adalah daftar seluruh Pekerja.
@endsection
...
@section('content')
  ...
  @component('components.datatables')
    ...
    @slot('buttons')
      <a href="{{ route('room.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i>&nbsp;Tambah Pekerja</a>
    @endslot
