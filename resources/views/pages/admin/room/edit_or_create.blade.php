...
@section('title')
  @if(isset($item))
    Edit Data Pekerja - A-KUL
  @else 
    Tambah Data Pekerja - A-KUL
  @endif
@endsection 
...
@section('breadcrumbs')
  <div class="breadcrumb-item"><a href="#">Pekerja</a></div>
  <div class="breadcrumb-item"><a href="{{ route('room.index') }}">Data Pekerja</a></div>
  <div class="breadcrumb-item @if(isset($item)) '' @else 'active' @endif">
    @if(isset($item))
      <a href="#">Edit Data Pekerja</a>
    @else 
      Tambah Data Pekerja
    @endif
  </div>
...
@section('section-lead')
  Silakan isi form di bawah ini untuk @if(isset($item)) mengedit data {{ $item->name }} @else menambah data Pekerja. @endif
@endsection
...
@section('content')
  ...
  @component('components.form')
    ...
    @slot('input_form')
      ...
      @component('components.input-field')
          @slot('input_label', 'Kapasitas tim')
