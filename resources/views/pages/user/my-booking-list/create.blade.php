...
@section('content')
  ...
  @component('components.form')
    ...
    @slot('input_form')
      ...
      @component('components.input-field')
          @slot('input_label', 'No Hp')
          @slot('input_type', 'number')
          @slot('input_name', 'no_hp')
          @slot('form_group_class', 'required')
          @slot('other_attributes', 'required')
      @endcomponent
      ...
      @component('components.input-field')
          @slot('input_label', 'Dana')
          @slot('input_type', 'number')
          @slot('input_name', 'dana')
          @slot('form_group_class', 'required')
          @slot('other_attributes', 'required')
      @endcomponent
      ...
      @component('components.input-field')
          ...
          @slot('input_name', 'nota')
          @slot('input_value', 'NULL')
          @slot('form_group_class', 'required')
          @slot('other_attributes', 'required')
      @endcomponent
